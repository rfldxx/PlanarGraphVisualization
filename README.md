## ТЕОРИЯ
[Визуализация планарных графов и PQ-дерево](https://docs.google.com/document/d/1Phu3D5hN_ZWfyoyfQY5DuFb3Coj_038m/edit?usp=sharing&ouid=103567448059985701124&rtpof=true&sd=true). (Пока ещё находится в перечитке.) 

## ТЕКУЩЕЕ: добавить модуль вращений.

Пример этого модуля отдельно:

![](images/PQ_operations_demo.gif)
